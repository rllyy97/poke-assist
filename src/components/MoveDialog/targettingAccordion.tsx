...
const TargettingAccordion = ({ target }) => {
  ...
  return (
    <Accordion style={{ boxShadow: 'none' }}>
      <AccordionSummary id="targetting" expandIcon={<ExpandMoreIcon />}>
        <Typography>Move target</Typography>
      </AccordionSummary>
      <AccordionDetails>
        <TargettingContainer>
...
export default TargettingAccordion
